...
import BookmarkPosts from '../../app/(tabs)/(discussion)/bookmark-posts'
...
describe('BookmarkPost Unit Test', () => {
  beforeEach(() => {
    jest.clearAllMocks()
    mockActiveChains = {}
  })
  ...
  it('posts are filtered according to search posts', async () => {
    const mockFeedPosts = [
      { id: 'post-1', title: 'React Native Tutorial', category: 'Progress', score: 10 },
      { id: 'post-2', title: 'Weightlifting Advice', category: 'Discussion', score: 5 }
    ]
    const mockUserBookmarks = [
      { id: 'b1', post_id: 'post-1', user_id: mockUserSubId },
      { id: 'b2', post_id: 'post-2', user_id: mockUserSubId }
    ]
    ...
    mockActiveChains['bookmarks'] = {
      select: jest.fn().mockReturnThis(),
      eq: jest.fn().mockReturnThis(),
      then: jest.fn().mockImplementation((resolve) => 
        Promise.resolve(resolve({ data: mockUserBookmarks, error: null }))
      )
    }

    await act(async () => render(<BookmarkPosts />))
  ...
  it('posts are filtered according to category', async () => {
    const mockFeedPosts = [
      { id: 'post-1', title: 'Check out my gains', category: 'Progress', score: 10 },
      { id: 'post-2', title: 'Bench press form help', category: 'Help', score: 5 }
    ]
    const mockUserBookmarks = [
      { id: 'b1', post_id: 'post-1', user_id: mockUserSubId },
      { id: 'b2', post_id: 'post-2', user_id: mockUserSubId }
